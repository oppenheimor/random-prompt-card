export const PROMPT_LIST = [{
  ...
  attention: '需上传参考图片： 《戴珍珠耳环的少女》图片 。',
  imgUrl: '26.png'
}, {
  id: 27,
  name: 'Q 版表情包制作',
  prompt: '创作一套全新的 chibi sticker，共六个独特姿势，以用户形象为主角：1. 双手比出剪刀手，俏皮地眨眼；2. 泪眼汪汪、嘴唇微微颤动，呈现可爱哭泣的表情；3. 张开双臂，做出热情的大大拥抱姿势；4. 侧卧入睡，靠着迷你枕头，带着甜甜的微笑；5. 自信满满地向前方伸手指，周围点缀闪亮特效；6. 手势飞吻，周围飘散出爱心表情。保留 chibi 美学风格：夸张有神的大眼睛、柔和的面部线条、活泼俏皮的短款黑色发型、配以大胆领口设计的白色服饰，背景使用充满活力的红色，并搭配星星或彩色纸屑元素进行装饰。周边适当留白。Aspect ratio: 9:16',
  attention: '需上传参考图片： 《戴珍珠耳环的少女》图片 。',
  imgUrl: '27.png'
}, {
  id: 28,
  ...
  attention: '需上传参考图片： 一张清晰头像照片。',
  imgUrl: '28.png'
}, {
  id: 29,
  name: '名画人物 OOTD',
  prompt: '为图片人物生成不同职业风的OOTD，时尚穿搭和配饰，和人物色系一致的纯色背景，Q版 3d，c4d渲染，保持人脸特征，姿势都要保持一致，人物的比例腿很修长构图：9:16顶部文字：OOTD，左侧为人物ootd q版形象，右侧为穿搭的单件展示先来第一个职业：时尚设计师',
  attention: '需上传参考图片： 《戴珍珠耳环的少女》图片 。',
  imgUrl: '29.png'
}, {
  id: 30,
  ...
  id: 31,
  name: '动漫贴纸集合',
  prompt: '帮我生成一个动漫贴纸集合，包含6个不同的贴纸，每个贴纸的风格要和我上传的图片人物的风格一致，每个贴纸的大小要为9:16，背景要为透明。',
  attention: '需上传参考图片',
  imgUrl: '31.png'
}, {
  id: 32,
  ...
  id: 37,
  name: '柔和风格3D广告',
  prompt: '将一张照片转换为 3D 人物模型，人物模型要和照片人物的风格一致，人物模型要为 Q 版 3D，人物模型要为透明背景。',
  attention: '可替换提示词中的 [品牌产品] 为具体的产品描述。',
  imgUrl: '37.png'
}, {
  id: 38,
  name: '手绘信息图卡片',
  ...
  attention: '可替换 {Programmer} 括号内的职业为Designer、Doctor等等。需上传参考图片： 可选。可根据职业或角色描述生成，或上传照片作为参考。',
  imgUrl: '44.png'
}, {
  id: 45,
  name: '3D Q版大学拟人化形象',
  prompt: '给 {西北工业大学} 画一个拟人化的3D Q版美少女形象，体现学校 {航空航天航海三航} 特色',
  attention: '可替换 {西北工业大学} 括号内的学校名称和特色描述以生成不同大学的拟人化形象。',
  imgUrl: '45.png'
},  {
  id: 46,
  name: '快乐胶囊制作',
  prompt: '标题（大字）：速效快乐胶囊一颗上为星巴克绿下为透明的小药丸，上面印有星巴克logo，里面有很多咖啡豆说明（小字）：请在悲伤难过时服用，一日三次，一次两粒购买按钮 和 药丸颜色一致，下面价格：$9，请遵循医嘱酌情购买',
  attention: '',
  imgUrl: '46.png'
}, {
  id: 47,
  ...
  id: 48,
  name: '体素风格 3D 图标转换',
  prompt: '三个步骤 1. 上传参考图 2. 上传要转换的照片 3. 提示词：将图片/描述/emoji转换为参考图一样的体素 3D 图标，Octane 渲染，8k',
  attention: '需上传参考图片： 体素风格图标的参考图从原文链接1获取；以及一张要转换的原始图标。',
  imgUrl: '48.png'
}, {
  id: 49,
  name: '时尚杂志封面风格',
  ...
  attention: ' 可替换提示词中括号内的城市、国家、地标和日期。示例图使用罗马、意大利、罗马斗兽场、日期2025年4月16日。',
  imgUrl: '51.png'
}, {
  id: 52,
  name: '纸艺风格 Emoji 图标',
  ...
  attention: '这个提示词旨在生成一张看起来非常随意、甚至有点“失败”的快照风格照片。',
  imgUrl: '54.png'
}, {
  id: 55,
  name: '创意绿植花盆',
  ...
  attention: '可替换提示词中的 [物体/动物] 为具体的物体、动物名称或表情符号。',
  imgUrl: '55.png'
}, {
  id: 56,
  name: '迷你 3D 建筑',
  ...
  attention: '可以让 AI 参考上面的提示词，为你生成其他建筑的类似提示词。例如：参考上面的提示词，写一个类似的提示词，针对【DunkinDonuts】，【甜甜圈】造型',
  imgUrl: '56.png'
}, {
  id: 57,
  name: '8位像素图标',
  prompt: '创建一个极简主义的 8 位像素风格的 [🍔] 标志，居中放置在纯白背景上。使用有限的复古调色板，搭配像素化细节、锐利边缘和干净的块状形态。标志应简洁、具有标志性，并能在像素艺术风格中清晰识别——灵感来自经典街机游戏美学。',
  attention: '可替换提示词中的 [🍔] 为其他 Emoji 或对象。',
  imgUrl: '57.png'
}, {
  id: 58,
  name: '云彩艺术',
  prompt: '生成一张照片：捕捉了白天的场景，天空中散落的云彩组成了 [主体/物体] 的形状，位于 [地点] 的上方。',
  attention: '可替换提示词中的 [SUBJECT/OBJECT] （云彩形状的主体）和 [LOCATION] （地点）。示例图的主体是中国龙，地点是长城。',
  imgUrl: '58.png'
}, {
  id: 59,
  name: '彩色矢量艺术海报',
  prompt: '地点是"英国伦敦"，生成一张夏季的彩色矢量艺术海报，顶部有大的"LONDON"标题，下方有较小的"UNITED KINGDOM"标题',
  attention: '可替换提示词中的城市和国家名称（例如将"英国伦敦"替换为"中国北京"以生成示例图，大小标题也跟着更换）。此风格提示词也可用于食物、电影、音乐等主题。',
  imgUrl: '59.png',
}, {
  id: 60,
  name: 'Emoji 簇绒地毯',
  ...
  attention: '需上传参考图片： 需要上传一张人物或物体的照片作为转换主体。',
  imgUrl: '62.png',
}, {
  id: 63,
  name: 'Emoji 奶油雪糕',
  ...
  attention: '此图片展示了蒸汽朋克风格与金属材质的精美结合，呈现出精致的机械感和复古未来主义风格。',
  imgUrl: '64.png',
}, {
  id: 65,
  name: '奇幻水下场景冰棒',
  ...
  attention: ' 提示词采用类 JSON 结构描述卡片元素。可修改 parameters 对象中的值（如 logo, ticker, company_name, colors 等）来自定义卡片。对于自定义 Logo，需在 parameters.logo 中注明（例如："Framer logo (attached image)"）并上传图片。本提示词为结构化JSON，保持英文。需上传参考图片： （可选）上传自定义 Logo 图片。',
  imgUrl: '68.png',
}, {
  id: 69,
  name: '剪影艺术',
  prompt: '一个 [PROMPT] 的基础轮廓剪影。背景为亮黄色，剪影为纯黑色实心填充。',
  attention: '可替换提示词中的 [PROMPT] 为具体对象，例如 "dragon on a castle", "woman\'s profile" 等。',
  imgUrl: '69.png',
}, {
  id: 70,
  name: '原创宝可梦生成',
  ...
  attention: '如果第一次提示无效，尝试开启新对话或要求它绕过问题。需上传参考图片： 需要上传一张物体、食物等的照片作为灵感来源。',
  imgUrl: '70.png',
}, {
  id: 71,
  ...
  attention: '可替换提示词中的 [LOGO] 为具体品牌 Logo 描述（例如 "Apple logo", "McDonald\'s logo", "Nike logo" 等）。',
  imgUrl: '74.png',
}, {
  id: 75,
  name: '社交媒体相框融合',
  ...
  attention: '可替换提示词中的用户名『Beauty』及图标。需上传参考图片： 需要上传一张图片作为参考。',
  imgUrl: '75.png',
}, {
  id: 76,
  name: '怀旧动漫风格电影海报',
  ...
  attention: '可替换提示词中的电影名{The Lord of the Rings}为其他电影，某些电影可能会触发内容审核。参考的动漫风格也可以修改。',
  imgUrl: '76.png',
}, {
  id: 77,
  name: '水晶球故事场景',
  ...
  attention: '可替换提示词中括号 {} 内文字为故事场景描述，成语、故事、小故事都可以。',
  imgUrl: '77.png',
}, {
  id: 78,
  name: '玻璃材质重塑',
  ...
  attention: '此提示词通过 JSON 结构精确控制输出风格，并将上传图片重塑为指定材质。需上传参考图片： 需要上传一张要进行材质重塑的物体图片。',
  imgUrl: '78.png',
}, {
  id: 79,
  name: '乐高城市景观',
  ...
  attention: '可以用 AI 参考提示词示例生成其他城市景观。',
  imgUrl: '79.png',
}, {
  id: 80,
  name: '代码风格名片',
  ...
  attention: '替换最后的JSON代码中的name、title、email和link数据。提示词由原文链接中简化而来。',
  imgUrl: '80.png',
}, {
  id: 81,
  name: '半透明玻璃质感变换',
  prompt: "将附图变换为柔软的3D半透明玻璃，具有磨砂哑光效果和细致的纹理，原始色彩，以浅灰色背景为中心，在空间中轻轻漂浮，柔和的阴影，自然的光线",
  attention: '需上传参考图片： 需要上传一张实物参考图',
  imgUrl: '81.png',
}, {
  id: 82,
  name: '特色城市天气预报',
  ...
  attention: '城市、天气、温度和建筑名称可根据需求替换 [] 中的内容。',
  imgUrl: '82.png',
}, {
  id: 83,
  name: '发光线条解剖图',
  ...
  attention: '可替换提示词中的 [SUBJECT] (主体) 和 [PART] (部位)。',
  imgUrl: '83.png',
}, {
  id: 84,
  name: '动物硅胶腕托',
  ...
  attention: '中文提示词由英文原文翻译而来，基本能达到预期效果，不过使用英文提示词可能会获得更好的结果。',
  imgUrl: '86.png',
}, {
  id: 87,
  name: '字母与单词含义融合',
  prompt: "在字母中融入单词的含义，将图形和字母巧妙融合在一起。单词：{ beautify }下面加上单词的简要说明",
  attention: '替换单词{ beautify }为想要融合的单词',
  imgUrl: '87.png',
}, {
  id: 88,
  name: '儿童涂色页插画（含彩色参考图）',
  ...
  attention: '可替换提示词中的【】内容，例如适合人群和画面描述。',
  imgUrl: '88.png',
}, {
  id: 89,
  name: '镀铬emoji徽章',
  ...
  attention: '可将提示词中的【安妮海瑟薇】替换为其他人物名称。或者使用一张人物照片作为参考图片。需上传参考图片： 可使用一张人物照片作为参考图片。本示例的参考图片是 《戴珍珠耳环的少女》 。',
  imgUrl: '92.png',
}, {
  id: 93,
  name: '玻璃质感重塑',
  ...
  attention: '需上传参考图片： 需要上传一张图像作为重新纹理化的基础。',
  imgUrl: '93.png',
}, {
  id: 94,
  name: '三只动物与地标自拍',
  ...
  attention: '可替换提示词中的 [动物类型] 和 [地标] 为具体描述。',
  imgUrl: '94.png',
}, {
  id: 95,
  name: '自拍生成摇头娃娃',
  prompt: "将这张照片变成一个摇头娃娃：头部稍微放大，保持面部准确，身体卡通化。[把它放在书架上]。",
  attention: '请将提示词中的[把它放在书架上]替换为您想要的特定场景或背景，例如“把它放在书架上”或“把它放在办公桌上”，或“把它放在中性背景上”，或“生成透明背景”。需上传参考图片： 需要上传一张自拍照作为生成摇头娃娃的基础。',
  imgUrl: '95.png',
}, {
  id: 96,
  name: '定制动漫手办',
  ...
  attention: '需上传参考图片： 请上传一张包含人物全身姿势、面部表情及服装造型的照片，用于生成手办模型。',
  imgUrl: '96.png',
}, {
  id: 97,
  name: '可爱温馨针织玩偶',
  ...
  attention: '需上传参考图片： 上传一张照片作为参考，生成其可爱Q版针织玩偶形象。',
  imgUrl: '97.png',
}, {
  id: 98,
  name: '磨砂玻璃后的虚实对比剪影 ',
  prompt: "一张黑白照片，展示了一个[主体]在磨砂或半透明表面后的模糊剪影。其[部分]轮廓清晰，紧贴表面，与其余朦胧、模糊的身影形成鲜明对比。背景是柔和的灰色渐变色调，增强了神秘和艺术的氛围。",
  attention: '请在 [主体] 和 [部分] 中填入具体且富有画面感的描述，突出“模糊主体 + 清晰局部”的反差效果。 例如：[主体] 可写为“手持红色光剑的西斯领主”，[部分] 可写为“另一只聚集暗黑原力的手”。',
  imgUrl: '98.png',
}, {
  id: 99,
  name: '黑白肖像艺术',
